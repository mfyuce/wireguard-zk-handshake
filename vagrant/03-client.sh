...
ip link set wg1l up
wg set wg1l private-key "$KEYS/private_left" listen-port 51821
...
sleep 2
systemctl is-active wgzk && echo "==> wgzk daemon running (client)" || { journalctl -u wgzk --no-pager -n 20; exit 1; }
wg show wg1l
